defmodule Stripe.Subscription do
  ...
  (
    ...
    @type end_field :: %{
            ...
            optional(:type) => :min_item_period_end | :timestamp
          }
  )
  ...
  (
    ...
    @type start :: %{
            optional(:timestamp) => integer,
            optional(:type) => :max_item_period_start | :now | :timestamp
          }
  )
    ...
    (
      @spec create(
              params :: %{
                ...
                optional(:cancel_at) => integer | :max_period_end | :min_period_end,
                optional(:billing_thresholds) => billing_thresholds | binary,
  ...
  (
    ...
    @doc "<p>Upgrade the billing_mode of an existing subscription.</p>\n\n#### Details\n\n * Method: `post`\n * Path: `/v1/subscriptions/{subscription}/migrate`\n"
    (
      @spec migrate(
              subscription :: binary(),
              params :: %{
              ...
              {:ok, Stripe.Subscription.t()} | {:error, Stripe.ApiErrors.t()} | {:error, term()}
      def migrate(subscription, params \\ %{}, opts \\ []) do
        path =
          Stripe.OpenApi.Path.replace_path_params(
