defmodule Stripe.Token do
  ...
  (
    @typedoc "The persons ethnicity details"
  ...
  (
    @typedoc "The persons race details"
    @type race_details :: %{
            optional(:race) =>
              list(
                :african_american
  ...
  (
    @typedoc "Describes the person’s relationship to the account."
    @type relationship :: %{
  ...
  (
    @typedoc "Demographic data related to the person."
    @type us_cfpb_data :: %{
